...
public class VoxLinkMod {
    ...
    public VoxLinkMod() {
        ...
        //debounce Forge 46 不支持构造函数注入, 用 FMLJavaModLoadingContext 获取 mod bus (46/47 通用)
        IEventBus modEventBus = FMLJavaModLoadingContext.get().getModEventBus();
        //debounce FMLClientSetupEvent在mod bus RegisterCommands/ServerStopping在forge bus
        modEventBus.addListener(VoxLinkClient::onClientSetup);
        MinecraftForge.EVENT_BUS.addListener(VoxLinkMod::onRegisterCommands);
        MinecraftForge.EVENT_BUS.addListener(VoxLinkMod::onServerStopping);
