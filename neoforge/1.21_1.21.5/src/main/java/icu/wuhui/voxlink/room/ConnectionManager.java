    ...
    public void handleRelayRequest(String from, JsonObject data) {
        ...
        if (mc.player != null) {
            mc.player.displayClientMessage(
                Component.translatable("voxlink.relay.host_notice").withStyle(ChatFormatting.YELLOW), false);
        }
            ...
            rp.punch(fRelayIp, fRelayPort)
                ...
                .thenAccept(result -> {
                    ...
                    scheduler.schedule(() -> {
                        ...
                        if (mc.player != null) {
                            mc.player.displayClientMessage(
                                Component.translatable("voxlink.relay.connected_via").withStyle(ChatFormatting.YELLOW), false);
                        }
        ...
        if (mc != null) {
            mc.execute(() -> {
                if (mc.player != null) {
                    ...
                    if (state.roomInfo.isSameCgnat()) {
                        mc.player.displayClientMessage(
                                Component.translatable("voxlink.chat.same_cgnat_warning").withStyle(ChatFormatting.GRAY), false);
                    }
                }
                try {
