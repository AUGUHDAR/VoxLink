...
public class RoomInfo {
    ...
    private volatile String connectionMode = "";
    ...
    public enum PortStatus {
        UNKNOWN("voxlink.port_status.unknown"),
        REACHABLE("voxlink.port_status.reachable"),
        UNREACHABLE("voxlink.port_status.unreachable"),
        NO_ADDRESS("voxlink.port_status.no_address");

        public final String label;
        PortStatus(String label) { this.label = label; }
    }
    ...
    public void setConnectionMode(String connectionMode, boolean failed) {
        this.connectionMode = connectionMode;
