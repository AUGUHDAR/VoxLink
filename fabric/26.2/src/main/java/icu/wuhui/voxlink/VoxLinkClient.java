...
public class VoxLinkClient implements ClientModInitializer {
    ...
    public void onInitializeClient() {
        ...
        ClientTickEvents.END_CLIENT_TICK.register(client -> {
            if (ConnectionHelper.isConnecting() && !(client.gui.screen() instanceof net.minecraft.client.gui.screens.ConnectScreen)) {
            ...
            if (client.player == null && client.getSingleplayerServer() == null && room.getLocalBridgePort() > 0
                    && !(client.gui.screen() instanceof net.minecraft.client.gui.screens.ConnectScreen)
                    && !(client.gui.screen() instanceof icu.wuhui.voxlink.ui.AttemptingJoinScreen)) {
                autoLeaveTicks++;
