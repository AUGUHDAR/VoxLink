...
房间本身没有人数限制，支持非正版玩家，但在大厅开放时，房间名会经AI审核后才展示
...
双方都是非正版也能联机。建房的时候模组自动把服务器切成离线模式，客机进来后恢复。全程不用手动改任何东西。
 
遇到BUG怎么办
 
去GitHub提Issues，一定要带日志。建房方和加入方的都带上，日志路径：.minecraft/versions/你的版本/logs/latest.log。顺便描述一下双方是什么网络环境——家里宽带？校园网？手机热点？没有日志我真的猜不到你那边发生了什么 orz
